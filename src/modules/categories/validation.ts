...
export const createCategoryValidation = {
	body: z.object({
		...
		limit: z.number({ error: "O limite é precisa ser um número" }).positive({ message: "O limite deve ser um número positivo" }).optional(),
	}),
}
...
export type UpdateCategoryParams = z.infer<typeof updateCategoryValidation.params>