...
export const createTransactionValidation = {
  body: z.object({
    ...
    paymentMethod: z
      .enum(PaymentMethod, { error: 'O meio de pagamento é obrigatório' })
      .optional(),
    installmentTotal: z
      .number({ error: 'O total de parcelas é obrigatório' })
      .positive()
      .optional(),
...
export type UpdateTransactionDTO = z.infer<
  typeof updateTransactionValidation.body
>
