...
async function main() {
    const categories = [
        ...
        { slug: "subscriptions", name: "Assinaturas", type: TransactionType.expense },
        ...
        { slug: "investments", name: "Investimentos", type: TransactionType.expense },
        { slug: "transport", name: "Transporte", type: TransactionType.expense },
        { slug: "uncategorized", name: "Sem categoria", type: TransactionType.expense },
